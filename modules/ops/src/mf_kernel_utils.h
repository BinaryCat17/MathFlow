...
#define MF_GET_STRIDE_D(inst)  (ctx->reg_strides[(inst)->dest_idx])
#define MF_GET_STRIDE_S1(inst) (ctx->reg_strides[(inst)->src1_idx])
#define MF_GET_STRIDE_S2(inst) (ctx->reg_strides[(inst)->src2_idx])
#define MF_GET_STRIDE_S3(inst) (ctx->reg_strides[(inst)->src3_idx])
#define MF_GET_STRIDE_S4(inst) (ctx->reg_strides[(inst)->src4_idx])
