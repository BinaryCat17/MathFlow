...
#define MF_OP_LIST \
    ...
    MF_OP(SUM,     "Sum",     MF_OP_SUM,     MF_OP_CAT_REDUCTION, MF_TYPE_MASK_NUMERIC, MF_OUT_SAME_AS_INPUT, MF_SHAPE_SCALAR,    MF_ACCESS_GLOBAL,  "in",  NULL,  NULL,  NULL) \
    ...
    \
    /* --- Array Generators --- */ \
    MF_OP(RANGE,   "Range",   MF_OP_RANGE,   MF_OP_CAT_ARRAY,  MF_TYPE_MASK_NUMERIC, MF_OUT_FORCE_F32,     MF_SHAPE_DYNAMIC_1D, MF_ACCESS_LINEAR,  "count",NULL, NULL, NULL) \
    MF_OP(INDEX,   "Index",   MF_OP_INDEX,   MF_OP_CAT_ARRAY,  MF_TYPE_MASK_NUMERIC, MF_OUT_FORCE_F32,     MF_SHAPE_DYNAMIC_1D, MF_ACCESS_LINEAR,  "axis", NULL, NULL, NULL)
