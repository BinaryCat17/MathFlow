...
- [x] **Standalone Compiler CLI (`mfc`):** Создана утилита, которая принимает JSON и все связанные ресурсы, проводит полную валидацию и «запекает» их в один финальный картридж.
